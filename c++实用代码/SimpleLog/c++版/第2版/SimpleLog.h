...
#define SET_LOGPREFIX(s) CSimpleLog::str_prefix=s
#endif
#ifndef UNSET_LOGPREFIX
#define UNSET_LOGPREFIX CSimpleLog::str_prefix=NULL
#endif
#ifndef FIX_WRITELOG
#define FIX_WRITELOG(s)  CSimpleLog::prefix=true;m_log.writelog(s)
#endif
#ifndef FIX_WRITELOGX
#define FIX_WRITELOGX(s,...) CSimpleLog::prefix=true;m_log.writelogx(s,__VA_ARGS__)
#endif
#pragma endregion
...
#define THIS_FIX_WRITELOG(s) CSimpleLog::prefix=true;pThis->m_log.writelog(s)
#endif
#ifndef THIS_FIX_WRITELOGX
#define THIS_FIX_WRITELOGX(s,...) CSimpleLog::prefix=true;pThis->m_log.writelogx(s,__VA_ARGS__)
#endif
#pragma endregion
...
#define S_FIX_WRITELOG(f,s)  CSimpleLog::prefix=true;CSimpleLog::write(f,s)
#endif
#ifndef S_FIX_WRITELOGX
#define S_FIX_WRITELOGX(f,s,...) CSimpleLog::prefix=true;CSimpleLog::writex(f,s,__VA_ARGS__)
#endif
#pragma endregion
//===============================================================
...
#define SET_LOGPREFIX_(s) CSimpleLog::str_prefix=s;
#endif
#ifndef UNSET_LOGPREFIX_
#define UNSET_LOGPREFIX_ CSimpleLog::str_prefix=NULL;
#endif
#ifndef FIX_WRITELOG_
#define FIX_WRITELOG_(s)  CSimpleLog::prefix=true;WRITELOG(s);
#endif
#ifndef FIX_WRITELOGX_
#define FIX_WRITELOGX_(s,...) CSimpleLog::prefix=true;WRITELOGX(s,...);
#endif
#ifndef THIS_FIX_WRITELOG_
#define THIS_FIX_WRITELOG_(s) CSimpleLog::prefix=true;pThis->m_log.writelog(s);
#endif
#ifndef THIS_FIX_WRITELOGX_
#define THIS_FIX_WRITELOGX_(s,...) CSimpleLog::prefix=true;pThis->m_log.writelogx(s,__VA_ARGS__);
#endif
#pragma endregion
//===============================================================
//类声明
