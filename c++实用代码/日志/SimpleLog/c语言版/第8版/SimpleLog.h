...
#define LWRITELOG(pLog,strF,...) pLog->lwrite(pLog,strF,__VA_ARGS__)
#endif
#ifndef CLOSELOG
...
#define LUNSET_LOGPREFIX(pLog) pLog->pstr_prefix_l=NULL
#endif
#ifndef LFIX_WRITELOG
#define LFIX_WRITELOG(pLog,strF,...) pLog->pstr_prefix_l=SimpleLogPrefixL,pLog->prefix=1,pLog->lwrite(pLog,strF,__VA_ARGS__)
#endif
#pragma endregion
...
#define LWRITELOG2(pLog,strF,...) pLog->lwrite(pLog,L"!!"##FUNCTIONW(strF),__VA_ARGS__)
#endif
