...
字符串处理
    ${var}	        变量本来的值
    ${var:+word}	    如果变量 var 值不为空，则返回word，否则返回空（不改变 var 的值）。
    ${var:-word}	    如果变量 var 值不为空，则返回var的值，否则返回 word（不改变 var 的值）。
    ${var:=word}	    如果变量 var 值不为空，则返回var的值，否则返回 word（将 var 的值设置为 word）。
    ${var:?message}	    如果变量 var 值不为空，则返回var的值，否则将消息 message 送到标准错误输出。
    ${#var}          获取字符串长度
